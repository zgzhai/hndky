...
for i=1:n_iters
         T_amb_1(i)=T_amb+10;
         I_H_current_1(i)=0.9*I_H_current;
         p_sun_1(i)=p_sun; 
end
%%%%行矩阵转变成列矩阵%%%%%%%
            T_amb=T_amb_1';
...
%     Mi=Mi+1;
%     mID=[i,L,L1,T_oil_now,T_top_now,T_wnd_now];
%     xlswrite('mid_data1.xls',mID,1,['A',num2str(Mi)]);
